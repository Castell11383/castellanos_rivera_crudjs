...
class Cliente extends Conexion
{
    ...
    {
        $sql = "UPDATE clientes SET cliente_nombre = '$this->cliente_nombre', cliente_apellido = '$this->cliente_apellido', cliente_genero = '$this->cliente_genero'  where cliente_id = $this->cliente_id";
